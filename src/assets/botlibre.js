	...
	this.createBox = function() {
		...
		html = html
			...
			+ "<div id='" + this.prefix + "boxbar' class='" + this.prefix + "boxbar'>"
				+ "<div id='" + this.prefix + "boxbar2' class='" + this.prefix + "boxbar2'>"
					+ "<span><a id='" + this.prefix + "boxbarmax' class='" + this.prefix + "boxbarmax' " + " onclick='return false;' href='#'><img id='" + this.prefix + "boxbarmaximage' " + "src='" + SDK.url + "/images/maximizew.png'> " + this.caption + " </a>"
					// + " <a id='" + this.prefix + "boxclose' class='" + this.prefix + "boxclose' onclick='return false;' onclick='return false;' href='#'> <img src='" + SDK.url + "/images/closeg.png'></a>"
					+"</span><br/>"
				+ "</div>";
		html = html
				+ "<div id='" + this.prefix + "boxbar3' class='" + this.prefix + "boxbar3'" + ">"
					...
					// + " <a id='" + this.prefix + "boxclose2' class='" + this.prefix + "boxclose2' onclick='return false;' onclick='return false;' href='#'> <img src='" + SDK.url + "/images/closeg.png'></a>"
					+"</span><br/>"
				+ "</div>\n"
			+ "</div>\n";
...
function WebAvatar() {
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "avatarbox { position:fixed;bottom:10px;left:10%;z-index:152;margin:10px;" + border + divWidth + " }\n"
 ...
 * @property error
*/
function SDKConnection(appID) {
	SDK.applicationId=appID;
	this.user;
	this.domain;
	this.credentials = new Credentials();
